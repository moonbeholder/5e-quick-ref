data_action = [
    {
        ...
        bullets: [
            "When you take the Attack action, you make an attack. Whether you strike with a Melee weapon, fire a Ranged weapon, or make an attack roll as part of a spell, an attack has the following structure:</br><ol><li><b>Choose a Target.</b> Pick a target within your attack’s range: a creature, an object, or a location.</li><li><b>Determine Modifiers.</b> The DM determines whether the target has Cover and whether you have Advantage or Disadvantage against the target. In addition, spells, special abilities, and other effects can apply penalties or bonuses to your attack roll.</li><li><b>Resolve the Attack.</b> Make the attack roll. On a hit, you roll damage unless the particular attack has rules that specify otherwise. Some attacks cause special effects in addition to or instead of damage.</li></ol>",
